...
def plot_maps_ftheta(f, ii, jj, suptitle=''):
    ...
    ax1.imshow(np.cos(f_N), cmap=plt.cm.Blues, interpolation='none',
               extent=[mini, maxi, minj, maxj], origin='lower left')
    ax1.set_title('N')

    ax2 = fig.add_subplot(222)
    ax2.imshow(np.cos(f_E), cmap=plt.cm.Greens, interpolation='none',
               extent=[mini, maxi, minj, maxj], origin='lower left')
    ax2.set_title('E')

    ax3 = fig.add_subplot(223)
    ax3.imshow(np.cos(f_S), cmap=plt.cm.Reds, interpolation='none',
               extent=[mini, maxi, minj, maxj], origin='lower left')
    ax3.set_title('S')

    ax4 = fig.add_subplot(224)
    ax4.imshow(np.cos(f_W), cmap=plt.cm.Oranges, interpolation='none',
               extent=[mini, maxi, minj, maxj], origin='lower left')
    ax4.set_title('W')
...
def plot_map(z, ii, jj, title=''):
    ...
    cax1 = ax1.imshow(z, cmap=plt.cm.Greys, interpolation='none', extent=[
                      mini, maxi, minj, maxj], origin='lower left')
...
def test_selfconsist():
    ...
    fts.writeto('kernel_selfconsist_synth.fits',
                kernelsynth.transpose(), clobber=True)
