...
def f_get_covmap(sq1,sq2,N,debug=False):
    ...
    clip = lambda img: stats.sigmaclip(img,4,4).clipped
    ...
    if not doTest:
        ...
        for iP in range(Npairs):
            ...
            for Q in Quads:
                ...
                sq1 = ccd1.extract_region(Q,area='img',canonical=True,extension=-1)
                sq2 = ccd2.extract_region(Q,area='img',canonical=True,extension=-1)
