...
class NL02(NL01.NL01):
        ...
        **METACODE**
        ...
        for iC,CCDk in enumerate(CCDs):
            for jQ,Q in enumerate(Quads):
                ...
                fdict_singNL['meta']['corekwargs'][ckey] = dict(linestyle='-',marker='',
                    color=ijcolor)
    ...
    def extract_PTC(self):
        ...
        wpx = self.window['wpx']
        hpx = self.window['hpx']
        clipsigma = 4. # applying sigma clipping to deal with cosmic rays and imperfect cosmetics mask
        ...
        nl_ptc.f_extract_PTC(self, ccdobjcol, medcol, varcol, evarcol,
            binfactor=binfactor, clipsigma=clipsigma)
