...
def interpol_histo_linear(histo):
    ...
    try: ihisto[0] = _f_interp(-1.,np.array([histo[1],histo[2]]))
    except: stop()
    try: ihisto[-1] = _f_interp(+3.,np.array([histo[-3],histo[-2]]))
    except: stop()
...
if __name__ == '__main__':
    ...
    parser.add_option("-m", "--multithread", dest="multithread", default=1,
    ...
    parser.add_option("-i", "--inter", dest="interptype", default="linear",
