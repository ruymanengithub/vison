...
def run_ROE_LinCalib(inputsfile,incatfile,datapath='', respath='',doExtractFits=True):
    ...
    for ix,CHAN in enumerate(CHANNELS):
        ...
        figs[CHAN] = os.path.join(respath,'%s_%s_%s_ROE_NL.png' % (CHAN,ROE,Date))
...
if __name__ == '__main__':
    ...
    parser.add_option("-F","--FITS",dest="doExtractFits",action="store_true",default=False,help="Extract ADUs from FITS?")    
