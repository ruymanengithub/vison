...
if __name__ == '__main__':
    ...
    parser.add_option("-L","--list",dest="ELlist",default='None',help="Text file with exposure logs to be merged.")
    parser.add_option("-O","--output",dest="output",default='EXP_LOG_merged.txt',help="Output Merged EXP LOG.")
