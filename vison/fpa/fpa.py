...
def get_block_lists(design='initial'):
    ...
    if design == 'initial':
        ...
        block_lists['flight_blocks'] = ['BORN', 'CURIE', 'DIRAC', 'ERWIN', 'FOWLER',
                                        'GUYE', 'SKLODOWSKA', 'JULES2', 'KRAMERS', 'LORENTZ', 'MAX', 'NIELS']
...
FPA_MAP_initial = dict(
    ...
    # SLICE_6
    C_61=('NIELS', 'CCD1', (1, 0), '14471-01-01'),
    C_62=('NIELS', 'CCD2', (1, 0), '15081-20-02'),
    C_63=('NIELS', 'CCD3', (1, 0), '15053-01-01'),
