...
'dwell_v','dwell_s','exptime','shuttr','e_shuttr','pos_mirr','lambda','motr',
...
'fpga_ver','egse_ver','motr','motr_cnt','motr_siz','source','lambda','pos_mirr',
...
'MOTR','MOTR_CNT','MOTR_SIZ','SOURCE','LAMBDA','POS_MIRR','SN_CCD1','SN_CCD2',
